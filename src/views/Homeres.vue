...
<!--                                :total="Object.keys(learnSourceArr).length">-->
<!--                        </el-pagination>-->
                    </div>
                </aside>
            </section>
            <!-- <footer id="footer">
                <div>
                    <span>© <a href="https://www.peak-labs.com/">Peak Labs</a></span>
                    <span><a href="/redirect?link=terms">服务条款</a></span>
                    <span><a href="/redirect?link=help">使用帮助</a></span>
                </div>
                <a class="icon icon-peaklabs" href="https://www.peak-labs.com/" title="Peak Labs" aria-label="Peak Labs"></a>
                <div>
                    <span><a class="tight" href="http://www.beian.miit.gov.cn/" target="_blank" rel="nofollow">京 ICP 备 12045386 号 - 3</a></span>
                    <span><a class="tight" href="http://www.beian.gov.cn/portal/registerSystemInfo?recordcode=11010502037711" target="_blank" rel="nofollow">京公网安备 11010502037711 号</a></span>
                </div>
            </footer> -->
            <!-- <footer id="footer" :class="searchNoResult!=0?'noResult':''">
                <div>
                    <span><a href="/help" target="_blank">使用帮助</a></span>
                    <span><a href="http://www.datahorizon.cn" target="_blank">更多产品</a></span>
                    <span><a href="/about" target="_blank">关于我们</a></span>
                </div>
                <a class="icon icon-peaklabs" href="javascript:void(0)">Copyright  2018 - 2028 Data Horizon. All Rights Reserved.</a>
                <div>
                    <span><a class="tight" href="http://www.beian.miit.gov.cn/" target="_blank" rel="nofollow">粤ICP备18066998号-2
</a></span>
                    <span><a class="tight" href="http://www.beian.gov.cn/portal/registerSystemInfo?recordcode=11010802026543" target="_blank" rel="nofollow">京公网安备 11010802026543号</a></span>
                </div>
            </footer> -->
        </div>
